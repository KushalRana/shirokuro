...
func _ready():
	...
	var button_scale_x = 6.0/8 * w / $Sprite2D/Game_Over_Button.texture_normal.get_width()
	var button_scale_y =  5.0/8 * h / $Sprite2D/Game_Over_Button.texture_normal.get_height()
